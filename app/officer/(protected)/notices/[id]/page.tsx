...
//     queryKey: ["notice", params.id],
//     queryFn: async () => {
//       const res = await fetch(`http://localhost:4000/api/notices/${params.id}`);
...
//   if (!notice) return <div className="p-8">Notice not found</div>;
...
//         {isAdmin && (
//           <Button asChild>
//             <Link href={`/officer/notices/${notice.id}/edit`}>Edit</Link>
//           </Button>
//         )}
//       </div>
